      ...
      <main style={{ paddingTop: '64px' }}>
        <section style={{ maxWidth: '760px', margin: '0 auto', padding: '80px 5%' }}>
          ...
          {[
            {
              title: 'Who we are',
              body: 'comparecaravaninsurance.com.au is a comparison and referral platform that connects builders, tradies and contractors with specialist insurance brokers. We are committed to protecting your personal information in accordance with the Australian Privacy Act 1988.'
            },
            {
            ...
            {
              title: 'Your rights',
              body: 'Under the Australian Privacy Act you have the right to access the personal information we hold about you, to correct inaccurate information, and to request deletion of your data. To exercise any of these rights, contact us at hello@comparecaravaninsurance.com.au.'
            },
            {
              title: 'Cookies',
            ...
            {
              title: 'Contact',
              body: 'For any privacy-related queries, contact us at hello@comparecaravaninsurance.com.au.'
            },
          ].map(section => (
