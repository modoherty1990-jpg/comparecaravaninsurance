...
export const metadata = {
  title: 'How Matching Works | comparecaravaninsurance.com.au',
}
        ...
        <section style={{ maxWidth: '760px', margin: '0 auto', padding: '80px 5%' }}>
          ...
          <div style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ color: '#8faabf', lineHeight: 1.8, fontSize: '0.95rem' }}>
              Brokers who are dedicated construction specialists — meaning caravan insurance is their primary focus rather than one of many categories — receive an additional 2 point bonus. This reflects the real-world advantage of working with a broker who lives and breathes your industry.
            </p>
          </div>
